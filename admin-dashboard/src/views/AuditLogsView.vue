...
<template>
  <div class="p-5">
    <!-- [2026-08-02追加] 権限がない場合はエラーのみを表示し、絞込フォームや
    ...
    <template v-else>
      ...
      <p v-if="auditLogs.errorMessage" class="text-xs text-destructive">
      ...
      <p
        v-else-if="!auditLogs.isLoading && !auditLogs.errorMessage"
        class="text-xs text-muted-foreground"
      >
        — 記録なし —
      </p>
